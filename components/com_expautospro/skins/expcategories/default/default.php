...
$params_file = JPATH_COMPONENT . '/skins/expcategories/default/parameters/params.php';
if (file_exists($params_file))
    require_once $params_file;
ExpAutosProHelper::expskin_lang('expcategories', 'default');
...
$document->addStyleSheet(JURI::root() . 'components/com_expautospro/skins/expcategories/default/css/default.css');
$expcat = '';
