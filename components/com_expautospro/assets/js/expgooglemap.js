 ...
 **   @license		Commercial License                                              **
 \****************************************************************************************/
	...
	if(document.getElementById('jformcountry') != null){
            var addr_country=document.getElementById('jformcountry');
        }
	if(document.getElementById('jformexpprofilecountry') != null){
            var addr_country=document.getElementById('jformexpprofilecountry');
        }
	//var addr_state=document.getElementById('jformexpstate');
        var expaddrlink ='';
        if(addr_country != null){
	var addr_c = addr_country.options[addr_country.selectedIndex].text;
	//var addr_s = addr_state.options[addr_state.selectedIndex].text;
            if(addr_c && addr_country.value > 0){
                    expaddrlink += addr_c + ' ';
            }
        }
	/*
	if(addr_s && addr_state.value > 0){
		expaddrlink += addr_s + ' ';
	}
	*/
        var address = expaddrlink+vartext;
