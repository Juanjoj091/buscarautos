...
if($gall_style=='vert'){
    $document->addStyleSheet(JURI::root() . 'modules/mod_expautospro_jqgallery/css/adgallery/jquery.mod_ad-gallery_vert_bootstrap.css');
...
<?php if ($expimages) { ?>
    <?php if($gall_style=='vert'){ ?>
        ...
        #modexpjqgallery<?php echo $moduleid; ?> .mod_ad-image img{
            height:100%;
            width:100%;
            display: block;
            margin-left: auto;
        ...
        #modexpjqgallery<?php echo $moduleid; ?> .expjq_price{
            margin: 5px 0 0 0;
        }
...
<div id="modexpjqgallery<?php echo $moduleid; ?>" class="<?php echo $moduleclass_sfx; ?>">
    <?php if ($expimages): ?>
        <div class="slider_container thumbnail">
            <div class="ribbon"></div>
            <div id="modgallery<?php echo $moduleid; ?>" class="mod_ad-gallery"> 
                <div class="mod_ad-image-wrapper" style="width:49%;"> 
                </div> 
                <div class="mod_ad-nav expadnav" style="width:48%;"> 
                    <div class="mod_ad-thumbs"  style="height:79%;"> 
                                            ...
                                            <?php if($gall_style=='vert'):?>
                                                <span>
                                                    <?php if($img->make_name || $img->model_name):?>
                                                        <p class="exp_strong label">
                                                            
                                                            <?php
                                                            $text_string='';
                                                            if($img->make_name){
                                                                $text_string .= $img->make_name;
                                                            }
                                                            if($img->model_name){
                                                                $text_string .= " ".$img->model_name;
                                                            }
                                                    ...
                                                    <?php if($params->get('showprice')): ?>
                                                        <p class="expjq_price badge badge-inverse"><?php echo $price; ?></p>
                                                    <?php endif; ?>
                                                </span>
                                            <?php endif; ?>
                                        </div>
                ...
                <div style="clear:both;"></div>
                <div class="mod_ad-controls" style="width:49%;"> 
                </div> 
            </div>
        </div>
<?php endif; ?>
