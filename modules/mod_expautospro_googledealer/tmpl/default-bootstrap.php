...
$document->addStyleSheet(JURI::root() . 'modules/mod_expautospro_googledealer/css/mod_expautospro_googledealer_bootstrap.css');
...
$script .= "
    ...
    function dealerinitializeads1() {
      map = new google.maps.Map(document.getElementById('mapd" . $moduleid . "'), {
...
<div id="modexpgoogledealers<?php echo $module->id; ?>" class="modexpgoogledealers expgoogledealers<?php echo $moduleclass_sfx; ?>">
    <div class="expgmapdealersleft well">
        <div id="mapd<?php echo $moduleid; ?>" style="height: <?php echo $params->get('height'); ?>px"></div>
        <div class="expgmapdsearch">
            <form action="<?php echo $action_link; ?>" method="get">
                ...
                <?php endif; ?>
                <input id="expbutton<?php echo $moduleid; ?>" type="submit" name="Submit" class="button btn btn-primary" value="<?php echo JText::_('MOD_EXPAUTOSPRO_GOOGLEDEALERS_SEARCH_TEXT') ?>" />
                <div class="expautos_images_clear"></div>
                <?php if ($params->get('country')): ?>
