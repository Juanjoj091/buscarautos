...
$document->addStyleSheet(JURI::root() . 'modules/mod_expautospro_images/css/mod_expautospro_images_bootstrap.css');
$expconfig = ExpAutosProExpparams::getExpParams('config', 1);
$thumbsize = $expconfig->get('c_images_thumbsize_width');
$moduleid = $module->id;
?>
<style type="text/css">
    #modexpimages<?php echo $moduleid; ?> table.expautos_images_table .label{
        padding:2px 0;
    }
</style>
    ...
    <table class="expautos_images_table">
        ...
        for ($i = 0, $n = $countshortlist; $i < $n; $i++):
            ...
            <?php if (($c % $kr) == 0): ?>
                ...
                ?>
                <td valign="top" width="<?php echo $thumbsize; ?>" class=" <?php echo $imgclass; ?>">
                    <span class="">
                        <a class="thumbnail" href="<?php echo $link; ?>">
                            ...
                            <div class="expimg_text label label-info">
                                <?php if ($expimages[$i]->make_name || $expimages[$i]->model_name): ?>
                                    <div class="expautos_images_text expimg_strong initialism" style="width:<?php echo $thumbsize; ?>px;">
                                        <?php
