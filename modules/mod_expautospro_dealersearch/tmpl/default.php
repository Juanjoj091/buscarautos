...
$document->addStyleSheet(JURI::root() . 'modules/mod_expautospro_dealersearch/css/mod_expautospro_dealersearch.css');
...
<div id="modexpautospro_dealersearch<?php echo $moduleid ?>" class="dealersearch <?php echo $moduleclass_sfx ?>">
	...
	<?php if(!$exp_sef):?>
        ...
        <?php if($params->get('usecountry')):?>
            ...
            <?php endif;?>
        <input id="expbutton<?php echo $moduleid ?>" type="submit" name="Submit" class="button" value="<?php echo JText::_('MOD_EXPAUTOSPRO_DEALERSEARCH_SEARCH_TEXT') ?>" />
        <?php if($params->get('country')):?>
