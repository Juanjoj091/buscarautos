...
$document->addStyleSheet(JURI::root() . 'modules/mod_expautospro_mortgage/css/mod_expautospro_mortgage.css');
...
<input type="text" name="mcPrice" id="mcPrice" class="mortgageField input-medium" size="19" maxlength="255" value="<?php echo $price; ?>" />
</p>
...
<input type="text" name="mcRate" id="mcRate" class="mortgageField input-medium" size="19" maxlength="255"  value="<?php echo $definterest; ?>"/>
</p> 
...
<p><?php echo JText::_('MOD_EXPAUTOSPRO_MORGAGE_MONTHLYPAYMENT_TEXT'); ?> (<?php echo $currency; ?>)<br/>
  <input type="text" name="mcPayment" id="mcPayment" class="mortgageAnswer input-medium" />
</p>
</form>
</div>
