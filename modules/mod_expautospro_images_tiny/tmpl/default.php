...
$document->addStyleSheet(JURI::root() . 'modules/mod_expautospro_images_tiny/css/mod_expautospro_images_tiny.css');
...
<style type="text/css">
    ...
    #modexpimagestiny<?php echo $moduleid; ?> .tinyoverview li{width:<?php echo $thumbsize + 10; ?>px; margin: 0 10px 0 0;}
    #modexpimagestiny<?php echo $moduleid; ?> a:link, #modexpimagestiny<?php echo $moduleid; ?> a:visited {
    }
    #modexpimagestiny<?php echo $moduleid; ?> a:hover, #modexpimagestiny<?php echo $moduleid; ?> a:active, #main a:focus {
        color: #095197;
    }
</style>
...
<div id="modexpimagestiny<?php echo $moduleid; ?>" class="modexpimagestiny <?php echo $moduleclass_sfx; ?>">
    <a class="tinybuttons tinyprev" href="#">left</a>
   ...
   <a class="tinybuttons tinynext" href="#">right</a>
</div>