...
$script .= "
    ...
    function initializeads2() {
      // Change this depending on the name of your PHP file
      downloadUrl('index.php?option=com_expautospro&view=expcompare&format=ajax'+link2, function(data) {
    ...
    function expgdfindAddress2(expvalue){}
