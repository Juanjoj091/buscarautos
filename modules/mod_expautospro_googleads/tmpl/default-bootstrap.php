...
$document->addStyleSheet(JURI::root() . 'modules/mod_expautospro_googleads/css/mod_expautospro_googleads_bootstrap.css');
...
$script .= "
    ...
    var customIcons = {
      ...
      82: {
        icon: '" . JURI::root() . "modules/mod_expautospro_googleads/images/new_truck.png',
        shadow: '" . JURI::root() . "modules/mod_expautospro_googleads/images/shadow.png'
      },
      83: {
        icon: '" . JURI::root() . "modules/mod_expautospro_googleads/images/truck.png',
        shadow: '" . JURI::root() . "modules/mod_expautospro_googleads/images/shadow.png'
      },
      85: {
        icon: '" . JURI::root() . "modules/mod_expautospro_googleads/images/new_boat.png',
        shadow: '" . JURI::root() . "modules/mod_expautospro_googleads/images/shadow.png'
      },
      86: {
        icon: '" . JURI::root() . "modules/mod_expautospro_googleads/images/boat.png',
        shadow: '" . JURI::root() . "modules/mod_expautospro_googleads/images/shadow.png'
      }
    };
    function expchg1(){
...
<div id="modexpgoogleads<?php echo $module->id; ?>" class="modexpgoogleads expgoogleads <?php echo $moduleclass_sfx; ?>">
    <div class="expgmapleft well">
        <div id="map<?php echo $moduleid; ?>" style="height: <?php echo $params->get('height'); ?>px"></div>
        <div class="expgmapsearch">
            <form action="<?php echo $action_link; ?>" method="get">
                <fieldset class="expgoogleads_fieldset">
                    ...
                    <?php endif; ?>
                    <input id="expbutton<?php echo $moduleid; ?>" type="submit" name="Submit" class="button btn btn-primary" value="<?php echo JText::_('MOD_EXPAUTOSPRO_GOOGLEADS_SEARCH_TEXT'); ?>"  data-loading-text="<?php echo JText::_('MOD_EXPAUTOSPRO_GOOGLEADS_BTNTEXT_DESC'); ?>"/>
