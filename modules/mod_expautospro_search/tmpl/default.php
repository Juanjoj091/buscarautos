...
$document->addStyleSheet(JURI::root() . 'modules/mod_expautospro_search/css/mod_expautospro_search.css');
//print_r($list);
?>
    ...
    <form action="<?php echo $action_link; ?>" method="get">
        ...
        <fieldset class="expsutospro_search_fieldset">
            ...
            <?php if ($params->get('useshowhide')): ?>
                <span class="explinkshow"><a href="javascript:exptoggle('expshowhide<?php echo $moduleid; ?>','expsearchtext<?php echo $moduleid; ?>','<?php echo JText::_('MOD_EXPAUTOSPRO_SEARCH_MORE_TEXT'); ?>','<?php echo JText::_('MOD_EXPAUTOSPRO_SEARCH_CLOSE_TEXT'); ?>');" id="expsearchtext<?php echo $moduleid; ?>"><?php echo JText::_('MOD_EXPAUTOSPRO_SEARCH_MORE_TEXT'); ?></a></span>
                <br /><br />
                <div class="expclear"></div>
            <?php endif; ?>
            <input id="expbutton<?php echo $moduleid; ?>" type="submit" name="Submit" class="button" value="<?php echo JText::_('MOD_EXPAUTOSPRO_SEARCH_SEARCH_TEXT') ?>" />
            <?php if ($params->get('country')): ?>
