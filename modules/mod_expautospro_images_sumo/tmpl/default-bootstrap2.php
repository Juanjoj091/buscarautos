...
$document->addStyleSheet(JURI::root() . 'modules/mod_expautospro_images_sumo/css/mod_expautospro_images_sumo_bootstrap2.css');
...
<div id="modexpimagessumo<?php echo $moduleid; ?>" class="modexpimagessumo expimagessumo<?php echo $moduleclass_sfx; ?>">
    <table class="expautos_images_table table-striped">
        <?php
        $c = 0;
