...
$document->addStyleSheet(JURI::root() . 'modules/mod_expautospro_images_sumo/css/mod_expautospro_images_sumo_bootstrap3.css');
...
<div id="modexpimagessumo<?php echo $moduleid; ?>" class="modexpimagessumo expimagessumo<?php echo $moduleclass_sfx; ?>">
    <ul class="expautos_images_table">
        <?php
        ...
        for ($i = 0, $n = $countshortlist; $i < $n; $i++):
            ...
            ?>
                ...
                ?>
                <li style="width:<?php echo $block_width; ?>px" class="expautos_images_images <?php echo $imgclass; ?>">
                    <a href="<?php echo $link; ?>" class="thumbnail ">
                        <div class="modimg <?php echo $imgclass; ?> modexpimg expsumo_left_cont">
                            <span class="expicon"></span><img src="<?php echo $imglink; ?>" />
