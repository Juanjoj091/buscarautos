...
class ExpAutosProTableExpextrafield1 extends JTable {

    function __construct(&$_db) {
        parent::__construct('#__expautos_extrafield1', 'id', $_db);
    }
    ...
    function store($updateNulls = false) {
        $table = JTable::getInstance('Expextrafield1', 'ExpAutosProTable');
