...
class JFormFieldJusermenu extends JFormFieldList {
    ...
    public function getOptions($data=0) {
        ...
        if (!$data) {
            array_unshift($options, JHtml::_('select.option', '1', JText::_('COM_EXPAUTOSPRO_LINK_USERMENU_MYADS_TEXT')));
