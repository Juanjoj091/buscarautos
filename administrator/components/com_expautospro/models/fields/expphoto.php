...
class JFormFieldExpphoto extends JFormField {
    ...
    public function getInput() {
        ...
        $result = ExpAutosProImages::getExpParams('expuser', $table_id);
