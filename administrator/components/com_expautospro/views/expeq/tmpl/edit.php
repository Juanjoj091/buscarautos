...
<script type="text/javascript">
	Joomla.submitbutton = function(task)
	{
		...
		if (form.jform_catid.value == "0" && task != 'expbodytype.cancel'){
             ...
             */
		if (task == 'expeq.cancel' || document.formvalidator.isValid(document.id('expautosprocat-form'))) {
...
<form action="<?php echo JRoute::_('index.php?option=com_expautospro&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="expautosprocat-form" class="form-validate">
	<div class="width-60 fltlft">
		<fieldset class="adminform">
			<legend><?php echo empty($this->item->id) ? JText::_('COM_EXPAUTOSPRO_EQ_NEW_TITLE') : JText::sprintf('COM_EXPAUTOSPRO_EQ_EDIT_TITLE', $this->item->id); ?></legend>
