...
class ExpAutosProControllerExpadmanager extends JControllerForm {
    ...
    protected function allowAdd($data = array()) {
        ...
        if ($categoryId) {
            $allow = $user->authorise('core.create', $this->option . '.expadmanager.' . $categoryId);
        }
    ...
    protected function allowEdit($data = array(), $key = 'id') {
        ...
        if ($categoryId) {
            return JFactory::getUser()->authorise('core.edit', $this->option . '.expadmanager.' . $categoryId);
        } else {
    ...
    public function make_build_contr() {
        ...
        $model = $this->getModel('Expadmanager');
